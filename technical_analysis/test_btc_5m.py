...
rsi_window = 49
rsi_lower_threshold = 29
rsi_upper_threshold = 88
capital = 1_000_000
COM = 0.125 / 100

# RSI INDICATOR
rsi_indicator = ta.momentum.RSIIndicator(close=data_t.Close, window=rsi_window)
technical_data = pd.DataFrame()
technical_data["Close"] = data_t.Close
