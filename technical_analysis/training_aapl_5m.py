...
data = pd.read_csv("C:/Users/sebmg/OneDrive/Documentos/GitHub/official_second_proyect/official_second_proyect/data/aapl_project_train.csv").dropna()

n_shares = 93
stop_loss = 0.3797931715217154
take_profit = 0.2584377218497207
rsi_window = 33
rsi_lower_threshold = 30
rsi_upper_threshold = 81
capital = 1_000_000
COM = 0.125 / 100
