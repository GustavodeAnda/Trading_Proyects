...
for combination in all_combinations:
    study = optuna.create_study(direction='maximize')
    study.optimize(func=lambda trial: profit_calculator.profit(trial, data_aapl, combination), n_trials=50)
...
print(f"Best outcome: {best_outcome_apple_5min}")
...
# Saving file
with open("../machine_learning/best_outcome_apple_5min.txt", "w") as file:
